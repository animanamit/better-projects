...
export const mockData: {
  ...
  tasks: [
    ...
    {
      id: "task-54",
      title: "Ensure compliance of authentication system with privacy regulations",
      description:
    ...
    {
      id: "task-58",
      title: "Update security audit procedures for compliance with privacy requirements",
      description:
